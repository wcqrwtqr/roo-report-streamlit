...
def intro():
    ...
    st.markdown(
        """
        This website is ment to be used for generating SGS report and graphing\
        Dowh Hole Memory gauges used for ROO operation and easy of exporting \
        Final reports for our clinet.\n
        You can generate graphs and adjust it to the duration you desire and\
        calculate the average values of the selected fields
